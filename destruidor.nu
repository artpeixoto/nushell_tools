        ...
        export def detonador [] : [any -> record<inimigo: string>]  { 
            ...
            let task_prompt = "TASK: " + "Resolve the following task. You response must be composed SOLELY of JSON. It should include no commentaries nor markdown. Follow output schema defined ahead. 
---
TASK: destrua os seus inimigos
---
SCHEMA: {
  "properties": {
    "output": {
